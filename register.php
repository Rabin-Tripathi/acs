...
<?php
    ...
    if (isset($_POST['submit'])) {
       ...
       // $salt = "kjb%G$15ef21$2mj$21b&eff21!f5g";
       // $hasedpassword=hash('sha256',$password.$salt);
            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'rabintripathi10@gmail.com';                     //SMTP username
                        $mail->Password   = 'emwwamqnmoqjspli';                               //SMTP password
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/myProject/?verification='.$code.'">http://localhost/myProject/?verification='.$code.'</a></b>';
